...
----------------------------------
Please refer to the self code of ``build_optimizer``/``build_lr_scheduler`` in :ref:`torchreid_optim` for details.
